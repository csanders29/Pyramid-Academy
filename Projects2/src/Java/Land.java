...
public class Land {
    ...
    public static String combat(){
        ...
        switch(a){
            case 1:
                s = "Human kills Goblin! Human wins!";
                break;
            case 2:
                s = "Goblin kills Human. Goblin wins!";
                break;
            case 3:
                s = "Human injures Goblin! Goblin retreats! Human wins!";
                break;
            case 4:
                s = "Goblin injures Human! Human retreats! Goblin wins!";
                break;
            case 5:
                s = "Both Human and Goblin injured! Both bled out to death!";
                break;
        }
